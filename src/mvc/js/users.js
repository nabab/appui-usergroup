...
(function(){
  ...
  return {
    ...
    methods: {
      ...
      insert(){
        return this.$refs.table.edit(null, bbn._("Création d'un user"), { width:'350px', height:'300px' });
      },
      edit(row){
        return this.$refs.table.edit(row, bbn._("Modification d'un user"), { width:'350px', height:'300px' });
      },
